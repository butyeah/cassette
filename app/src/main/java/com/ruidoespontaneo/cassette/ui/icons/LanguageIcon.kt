...
private var language: ImageVector? = null

/** Material's "language" (globe) glyph — drawn here from its path data for the same reason as [Pause]. */
val Icons.Filled.Language: ImageVector
    get() = language ?: materialIcon(name = "Filled.Language") {
        addPath(
            pathData = addPathNodes(
                "M11.99,2C6.47,2 2,6.48 2,12s4.47,10 9.99,10C17.52,22 22,17.52 22,12S17.52,2 11.99,2z" +
                    ...
                    "M14.34,14L9.66,14c-0.09,-0.66 -0.16,-1.32 -0.16,-2 0,-0.68 0.07,-1.35 0.16,-2h4.68c0.09,0.65 " +
                    "0.16,1.32 0.16,2 0,0.68 -0.07,1.34 -0.16,2z" +
                    "M14.59,19.56c0.6,-1.11 1.06,-2.31 1.38,-3.56h2.95c-0.96,1.65 -2.49,2.93 -4.33,3.56z" +
                    "M16.36,14c0.08,-0.66 0.14,-1.32 0.14,-2 0,-0.68 -0.06,-1.34 -0.14,-2h3.38c0.16,0.64 " +
                    "0.26,1.31 0.26,2s-0.1,1.36 -0.26,2h-3.38z"
            ),
