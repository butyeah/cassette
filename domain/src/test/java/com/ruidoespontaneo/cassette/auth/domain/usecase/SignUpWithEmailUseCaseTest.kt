...
class SignUpWithEmailUseCaseTest {
    ...
    fun `forwards email and password to the repository`() = runBlocking {
        ...
        val useCase = SignUpWithEmailUseCase(
    ...
    fun `returns the repository's failure unchanged`() = runBlocking {
        ...
        val useCase = SignUpWithEmailUseCase(fakeRepository { _, _ -> Result.failure(error) })
    ...
    private fun fakeRepository(
        signUpWithEmail: suspend (email: String, password: String) -> Result<Unit>
