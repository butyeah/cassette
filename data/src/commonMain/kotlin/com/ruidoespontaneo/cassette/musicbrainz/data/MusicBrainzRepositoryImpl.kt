...
class MusicBrainzRepositoryImpl @Inject constructor(
    ...
    override suspend fun getAlbumsByDate(
        ...
        return try {
            ...
            logError(e, "MusicBrainz search failed")
            Result.failure(e)
        }
    }
    ...
    override suspend fun getAlbumDetail(id: String): Result<AlbumDetail> {
        return try {
            ...
            logError(e, "MusicBrainz release-group lookup failed for $id")
            Result.failure(e)
        }
    }
    ...
    override suspend fun getAlbumTracks(id: String): Result<List<Track>> {
        return try {
            ...
            logError(e, "MusicBrainz tracklist lookup failed for release group $id")
            Result.failure(e)
        }
    }
